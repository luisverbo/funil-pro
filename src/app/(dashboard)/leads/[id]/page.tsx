...
const EVENT_LABELS: Record<string, string> = {
  ...
  entered_agent: '🤖 Entrou em conversa com agente',
  agent_activated: '🤖 Agente ativado',
  agent_deactivated: '🤖 Agente desativado',
  agent_error: '⚠️ Erro no agente',
...
const EVENT_COLORS: Record<string, string> = {
  ...
  entered_agent: 'bg-indigo-100 text-indigo-600',
  agent_activated: 'bg-indigo-100 text-indigo-600',
  agent_deactivated: 'bg-indigo-100 text-indigo-600',
