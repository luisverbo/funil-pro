...
const TEMPLATE_OPTIONS = [
  ...
  { id: 'thankyou', label: 'Obrigado Simples', description: 'Check animado + redirect', icon: '🙏' },
  { id: 'sales', label: 'Carta de Vendas Completa', description: '15 seções de alta conversão', icon: '🚀' },
]
            ...
            <div key={page.id} className="bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden flex flex-col">
              ...
              <div className="px-4 pb-4 flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 border border-red-100 text-red-400 text-sm font-medium rounded-lg hover:bg-red-50 transition-colors"
                  title="Excluir"
                >
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg">
            ...
            {step === 1 && (
              <div className="p-6">
                ...
                <button onClick={() => setStep(2)} className="mt-6 w-full py-3 bg-indigo-600 text-white font-medium rounded-xl hover:bg-indigo-700 transition-colors">
                  Continuar →
                </button>
              </div>
            )}
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3 mt-6">
                  ...
                  <button
                    ...
                    disabled={!pageName.trim() || isPending}
